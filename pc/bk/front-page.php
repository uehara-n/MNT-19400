...
get_header(); ?>
  ...
  <section class="intro-bg">
    <div class="intro-text">
      ...
      <p class="mb20">
        私達エンラージは、単なる建築リフォーム業者ではありません。<br>
お客様にとって『価値のあるリフォーム』をご提供する会社です。
      </p>
      <p class="mb20">
        リフォームは、壊れたものを直す“修繕”ではありません。 <br>
住まいをより良く作り直し、より良い生活を実現させるための手段です。
      </p>
      <p class="mb20">
        私達エンラージスタッフは『お客様を幸せにする事』を使命とし、全力を尽くします。 <br>
そのための努力は一切惜しみません。
      </p>
      <p class="mb20">
      ...
      <p class="mb20">
        「リフォームはサービス業である。」という精神は、現場にも浸透しています。<br>
挨拶や養生といった基本はもちろんの事、他では出来ない事を実現する“技術力”も<br>エンラージならではのサービスです。
      </p>
      <p class="mb20">
        “お客様にとって、価値のあるリフォーム” <br>
私達エンラージスタッフと一緒に、ご家族の夢や希望を叶えてみませんか？
      </p>
    </div>
  </section>
  <!-- 2.イベント情報・最新情報 -->
  <section class="ptb90">
    <div class="centering info-bg">
      <div class="info-row">
        <!-- イベント情報 -->
        <div class="info-col">
          <h2 class="section-title mt_10">イベント情報</h2>
          <p class="fukidashi"><img src="<?php echo get_template_directory_uri(); ?>/img/top/event/fuki.png" alt="エンラージの最新イベント"></p>
...
<?php wp_reset_postdata(); ?>
  ...
  <!-- 7.スタッフブログ -->
  <section class="section bg3 blog-frame">
    <div class="centering mb">
      <h2 class="section-title center">スタッフブログ</h2>
      <p class="section-subtitle center">Staff Blog</p>
      <p class="center mt20 mb30"><img src="<?php echo get_template_directory_uri(); ?>/img/top/staffblog/fuki.png" class="spfit" alt="エンラージスタッフの日々を更新中"></p>
      <?php $args = array(
        'post_type' => 'staffblog',
        'posts_per_page' => 3,
        'order' => 'DESC',
      ...
      <?php endwhile; ?>
          ...
          <?php wp_reset_postdata(); ?>
  <p class="center">
    <a href="<?php echo home_url(); ?>/staffblog/"><img src="<?php echo get_template_directory_uri(); ?>/img/top/staffblog/more.png" alt="もっとスタッフブログを見る"></a>
  </p>
</div>
</section>
    <!-- 8.ギャラリー・instagram -->
